...
| :--------------------------------------------------------------: | :---------------------------------------------------------------------: |
| <img src="./img/tea_sample.jpg" width="500"> | <img src="./img/result2.jpg" width="500"> |
...
|   層    |                                 圖片                           |
| :-----: | :-----------------------------------------------------------: |
|  side7  |   <img src="./img/gradCAM_small.jpg" width="500">   |
...
| :--------------------------------------------------------: | :----------------------------------------------------------------: |
| <img src="./img/result/218赤葉枯病train.JPG" width="500"> | <img src="./img/218赤葉枯病train.JPG" width="500"> |

對於外部資料集驗證
|                   外部資料集(茶樹徵狀照片)                    |                          推論結果(模型判斷病害結果)                   |
| :----------------------------------------------------: | :----------------------------------------------------------: |
| <img src="./img/result/1866test藻斑病.JPG" width="500"> | <img src="./img/1866test藻斑病gradcam.JPG" width="500"> |
